...
define('REDIS_DOWN_LOCK_FILE', '/tmp/z-push-redis-down');
// indicates how long the lock file will be maintained (in seconds)
define('REDIS_DOWN_LOCK_EXPIRATION', 30);

// Prefix to used for keys
define('REDIS_PREFIX', 'z-push-ipc');

// Connection timeout in seconds
define('REDIS_TIMEOUT', 0.1);

// Mutex timeout (in seconds)
define('REDIS_MUTEX_TIMEOUT', 5);

// Waiting time before re-trying to aquire mutex (in ms), must be higher than 0
define('REDIS_BLOCK_WAIT', 10);
